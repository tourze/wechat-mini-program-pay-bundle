 ...
 * @internal
 */
#[CoversClass(RefundCallbackController::class)]
#[RunTestsInSeparateProcesses]
final class RefundCallbackControllerTest extends AbstractWebTestCase
{
    public function testControllerCanBeInstantiated(): void
    {
        ...
        $controller = $container->get(RefundCallbackController::class);

        $this->assertInstanceOf(RefundCallbackController::class, $controller);
    }

    public function testControllerHasInvokeMethod(): void
    {
        $reflection = new \ReflectionClass(RefundCallbackController::class);
    ...
    {
        $reflection = new \ReflectionMethod(RefundCallbackController::class, '__invoke');
        $parameters = $reflection->getParameters();

        $this->assertCount(3, $parameters);
        $this->assertEquals('account', $parameters[0]->getName());
        $this->assertEquals('refundOrder', $parameters[1]->getName());
